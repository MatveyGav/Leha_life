...
def bank_1(screen, actions, Leha):
    ...
    # Создание сцены
    scene = Scene(screen, "data/bank_1.png", buttons, actions, Leha)
    return scene.run()
...
def bank_1_1(screen, actions, Leha):
    ...
    # Создание сцены
    scene = Scene(screen, "data/bank_1_1.png", buttons, actions, Leha)
    return scene.run()
...
def home_sleep(screen, actions, Leha):
    ...
    scene = Scene(screen, "data/home_1.png", None, actions, Leha)
    scene.fade_out()
